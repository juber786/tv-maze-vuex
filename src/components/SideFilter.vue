<template>
     <div class="filter-block">
              <div class="filter-content">
                 ...
                 <div>
                   <label>Country</label>
                    <select @change="filterData(selectedCountry, 'Country')" class="form-control" v-model='selectedCountry'>
                        <option value="">Select</option>
                 ...
                 <div>
                    <label>Network</label>
                    <select  @change="filterData(selectedNetwork, 'Network')" class="form-control" v-model='selectedNetwork'>
                          <option value="">Select</option>
